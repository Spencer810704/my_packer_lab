                          ...
                          if (fileExists('packer-manifest.json')) {
                              ...
                              if (manifest.builds?.size() > 0) {
                                  ...
                                  if (amiId) {
                                      ...
                                      // 基本標籤
                                      sh "aws ec2 create-tags --region ${params.AWS_REGION} --resources ${amiId} --tags
